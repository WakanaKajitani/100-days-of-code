...
## 閑話休題 2020/07/07 Tue
* 今日は何もしないって決めてたけど、気がついたらMENTAでWebデザイナーの方のコース契約していた。月35000円。<br>
個人のレベルに合わせた勉強方法を実務形式で出してくれて、相談やコードレビュー依頼もできて。本当にありがたい<br>
※ただし翌日は手続きやら買い出しやらで満足してやる気出ず、コード書かず外を走ってました。

## Day28 2020/07/06 Mon
**学習時間**: 3時間

**今日の進捗**: ずくろぐさんの、下線部が引かさるモーションを作ろうとして挫折

**思ったこと**: モチベーションを上げるために、動く物を作ろうとしてあえなく失敗。<br>
モーションの解読をディベロッパーツールでする実力はまだなかった。。。<br>
モチベーション下がり気味。。。並行してデザインの勉強を始めました。<br>
そちらの勉強は100日コードでは進捗報告しない。ただ、両立難しい。デザインの勉強に集中したいな。<br>
でもこの企画って、コーディングの継続のための物だから中断は違うし、、、<br>
かといって現状、デザイン能力が低め。cssはかけるのに、絵が浮かばない。モチーベーションにつながらない。<br>
Adobeのツールの使い方も勉強したい。<br>
方針と方法を考えないとなあ。

**リンク**
[Twitter ずいぶん前からDayずれてる](https://twitter.com/neanearly/status/1279790978874761217?s=20)
 

## Day27 2020/07/05 San
**学習時間**: 2時間

**今日の進捗**: 松風屋のコード模写その3。<br>
少しやって、ドットインストールのhtml入門を見ていた。<br>
htmlは、くくりよりもタグでコンテンツ内容がわかることが大事らしい<br>
あと、ショートカットがものすごく勉強になる。まだまだ知らないことたくさん。。。
以下、他にもためになったこと。
* 知らない属性(aタグのtarget,metaタグのdepriction など)
* はじめは汎用タグでざっとhtm作るのが良い。divなどのレイアウトは後からでもいける
* ディベロッパーツールの知らない使い方(compted, 外枠のmargn)
* divは色分けすると範囲がわかりやすい
* クラス名の雰囲気
* 最初はmargin,paddingディベロッパーツールで確認して、デフォルト設定リセットすること
* デザインは8の倍数

**思ったこと**: 多分、すぐに模写始める前に勉強しないといけないことたくさんある。<br>
だから進まないのだと思う。私は、コンテンツを売りたいのではなく、Webサイトを作る仕事がしたいのだから、<br>
この辺りは蔑ろにせず、突き詰めたい。

**リンク**
[Twitter](https://twitter.com/neanearly/status/1279790978874761217?s=20)

## Day26 2020/07/04 Sat
**学習時間**: 2時間

**今日の進捗**: 松風屋のコード模写その2。<br>
デフォルトのmarginや昨日入れたsassの設定パスでつまづく

**思ったこと**: なかなか進まなくてダレてる。そもそも昨日はしれっと本読んで休んでる。

**リンク**
[Twitter](https://twitter.com/neanearly/status/1279280503703531520?s=20)

**昨日読んでた本のツイート**
[centOSとは](https://twitter.com/neanearly/status/1279280503703531520?s=20)
[速読と単なる焦りの違い](https://twitter.com/neanearly/status/1278863631497584640?s=20)
[呟き](https://twitter.com/neanearly/status/1278868239548702721?s=20)
[急に引用]](https://twitter.com/neanearly/status/1278875442095648768?s=20)
[語学学習](https://twitter.com/neanearly/status/1278879584977477632?s=20)
[しみた部分の話](https://twitter.com/neanearly/status/1278884074178793472?s=20)

## Day25 2020/07/02 Thu
**学習時間**: 2時間

**今日の進捗**: 松風屋のコード模写開始！

**思ったこと**: あと、ドットインストールで仮想サーバーの構築もしました。<br>
virtualboxでcentOS

**リンク**
[Twitter](https://twitter.com/neanearly/status/1278587261416697856?s=20)

**芽生えた疑問のツイート**
[centOSとは](https://twitter.com/neanearly/status/1278510574712709120?s=20)
[勉強法・バナートレース](https://twitter.com/neanearly/status/1278532281712312321?s=20)
[サイト模写](https://twitter.com/neanearly/status/1278533096527155200?s=20)
[ansibleのコマンド](https://twitter.com/neanearly/status/1278537344627273728?s=20)
[ベンダープレフィックス](https://twitter.com/neanearly/status/1278572605042089984?s=20)
[ナビバーのcss](https://twitter.com/neanearly/status/1278587817321312258?s=20)

## Day24 2020/07/01 Wed
**学習時間**: 4時間
...
**今日の進捗**: Progate Node.jsコース修了<br>
と同時に、Progate 開発パス(Node.js)を修了！

**思ったこと**: Node.jsコースは、expressというJSのWebアプリケーションパッケージ(Ruby On Railsに似てる)と<br>
mySqlを使ってアプリケーションを開発するコースでした。<br>
npmの使い方の概要もかなりわかった。<br>
mySqlって簡単に導入できるのねー。感動<br>
何より、Day1から寄り道気味に進めていた開発パス(Node.js)を無事修了できた！<br>
何かが無事ゴールすると、達成感があるね。久しぶりに味わった気がする。<br>
そろそろ、本格的に、良いWebページを作る取り組みをしたいなー、このページのCSS整えたりしたい。<br>
と思いつつ、せっかくだからProgateの全コースを修了するのも楽しい。<br>
私の中で準備ができたら、Webサイト作成も自然と始めると思うので、焦らずやろうと思う。

**リンク**
[Twitter Day間違えてる](https://twitter.com/neanearly/status/1273844238904483840?s=20)

## Day15 2020/06/17 Wed
**学習時間**: 5時間

**今日の進捗**: Progate jQuery　修了

**思ったこと**: 一通りやりました！
<br>htmlのタグ、プロパティ、css、その辺りの知識を深めれば、もっと描けるようになると感じました。<br>
jQueryはそれありきだと思うので、その辺りをブラッシュアップした後にまた復習したコースでした。

**リンク**
[Twitter Day間違えてる](https://twitter.com/neanearly/status/1273146408313462786?s=20)


## Day14 2020/06/16 Tue
**学習時間**: 2時間

**今日の進捗**: Progate jQuery　コース開始！

**思ったこと**: フロントエンドの勉強ということでjQueryを開始。
画面の動きって、UXにかなり影響するから、簡単なことをできるだけで、一気に良いWebページになるよね。<br>
基本構文は↓。これをかれければ、あとは応用でかける言語。
``` jQueuery
$('オブジェクト').アクション(function() {
    $('オブジェクト').メソッド();
})
```

**リンク**
[Twitter](https://twitter.com/neanearly/status/1272792850070032385?s=20)




## Day13 2020/06/15 Mon
**学習時間**: 6時間
